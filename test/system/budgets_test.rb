...
class BudgetsTest < ApplicationSystemTestCase
  ...
  test "creating a Budget" do
    ...
    fill_in "B comment", with: @budget.b_comment
    fill_in "B money", with: @budget.b_money
    fill_in "B month", with: @budget.b_month
    fill_in "B year", with: @budget.b_year
    fill_in "Content", with: @budget.content_id
